...
<div>
    <x-mary-tabs wire:model="selectedTab" active-class="bg-primary rounded text-white" label-class="font-semibold"
        ...
        <x-mary-tab name="building-tab" label="Building Management" icon="o-home">
                ...
                <x-mary-stat title="Total Buildings" value="{{ count($buildings) }}" icon="o-building-office-2"
                    tooltip="Total number of houses" color="text-gray-600" class="text-gray-500" />
                <x-mary-stat title="Total Capacity"
                    value="{{ number_format(array_sum(array_column($buildings, 'max_capacity'))) }}"
                    icon="healthicons.o-animal-chicken" tooltip="Maximum bird capacity" color="text-blue-600"
                    class="text-blue-500" />
                <x-mary-stat title="Current Birds"
                    value="{{ number_format(array_sum(array_column($buildings, 'current_occupancy'))) }}"
                    icon="o-chart-bar" tooltip="Total current birds" color="text-green-600"
                    class="text-green-500" />
                {{-- <x-mary-stat title="Sq Footage"
                    value="{{ number_format(array_sum(array_column($buildings, 'square_footage'))) }}"
                    icon="o-square-2-stack" tooltip="Total square footage" /> --}}
            </div>
        ...
        <x-mary-tab name="Occupancy-tab" label="Flock Management" icon="o-users">
            <div class="p-6">
                <h2 class="text-xl font-bold mb-4 text-gray-900 dark:text-white">Flock Management</h2>
                <p class="text-gray-500 dark:text-gray-300">Flock tracking and performance metrics.</p>
            </div>
        </x-mary-tab>

        <x-mary-tab name="Maintenance-tab" label="Maintenance" icon="o-wrench-screwdriver">
            <div class="p-6">
                <h2 class="text-xl font-bold mb-4 text-gray-900 dark:text-white">Maintenance Schedule</h2>
                <p class="text-gray-500 dark:text-gray-300">Equipment maintenance and cleaning schedules.</p>
            </div>
        </x-mary-tab>
